 ...
 * $Revision:    V1.01
 *
 * Project:      Flash Device Description for ATSAML21
 * --------------------------------------------------------------------------- */
...
struct FlashDevice const FlashDevice  =  {
   ...
   "ATSAML21 32kB Flash",       // Device Name
   ONCHIP,                      // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAML21 64kB Flash",       // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAML21 128kB Flash",      // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAML21 256kB Flash",      // Device Name
   ONCHIP,                      // Device Type
   0x00000000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAML21 1kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAML21 2kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAML21 4kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAML21 8kB Data EEPROM",  // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
