 ...
 * $Revision:    V1.01
 *
 * Project:      Flash Programming Functions for ATSAML21
 * --------------------------------------------------------------------------- */
...
/* ---- SAM D20 ------------------------------------------------------------------*/
#if defined ATSAML21_256 || defined ATSAML21_128 || defined ATSAML21_64 || defined ATSAML21_32
  #define PAC_BASE             0x40000000
  #define NVMCTRL_BASE         0x41004000        /* SAML21                     */
#endif

#if defined ATSAML21_256
  #define FLASH_SIZE           0x40000
#endif

#if defined ATSAML21_128
  #define FLASH_SIZE           0x20000
#endif

#if defined ATSAML21_64
  #define FLASH_SIZE           0x10000
#endif

#if defined ATSAML21_32
